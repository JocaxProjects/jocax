...
//   • Page header breadcrumb: centered on mobile, left at lg+
//   • Page header title + product count: centered stack on mobile, row at lg+
//   • Search bar: full width on all sizes (already correct)
//   • Active filter chips: scroll strip (unchanged)
//   • Toolbar strip: filter btn left, sort right (unchanged — functional layout)
//   • Bottom CTA / pagination: centered (unchanged)
...
export default function ProductsClient({
  ...
  const FilterPanel = ({ inDrawer = false }: { inDrawer?: boolean }) => (
    <div className={inDrawer ? "space-y-6" : "space-y-6 sticky top-[calc(var(--nav-height)+1.5rem)]"}>
      <FilterSection title="Category">
        <FilterItem label="All Categories" active={!currentParams.category}
      ...
      <FilterSection title="Brand">
        <FilterItem label="All Brands" active={!currentParams.brand}
  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: "var(--color-catalog-bg)" }}>
      ...
      >
        <div style={{
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "0.5rem" }}>
            <svg style={{ width: "1rem", height: "1rem", color: "var(--color-amber)" }}
      ...
      {/* ════════════════════════════════════════════════════════════════
          PAGE HEADER
          Mobile: breadcrumb centered, title+count stacked centered
          Desktop (lg+): breadcrumb left, title row space-between
      ════════════════════════════════════════════════════════════════ */}
      <div style={{
        background: "var(--color-steel)",
        borderBottom: "1px solid rgba(255,255,255,0.06)",
      }}>
        <div className="container products-header-body" style={{ paddingBlock: "clamp(1.25rem, 4vw, 2rem)" }}>

          {/* Breadcrumb */}
          <nav style={{ marginBottom: "0.875rem" }} aria-label="Breadcrumb">
            <ol className="products-breadcrumb-ol" style={{
          ...
          */}
          ...
          {/* Search bar — full width, unchanged */}
              ...
              <div style={{ position: "absolute", right: "0.875rem", top: "50%", transform: "translateY(-50%)" }}>
                {(loading || isPending) ? (
                  <div style={{
                    ...
                    borderRadius: "var(--radius-full)", animation: "spin 0.7s linear infinite",
                  }}/>
                ) : searchValue ? (
                  <button
          ...
          {hasActiveFilters && (
            <div style={{
              ...
              {currentParams.q && (
                <ActiveChip label={`"${currentParams.q}"`}
          ...
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: "0.75rem" }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: "0.5rem", marginLeft: "auto" }}>
              <span style={{
                ...
                fontFamily: "var(--font-body)", fontWeight: 500, display: "none",
              }} className="md:block">Sort by:</span>
      ...
      <div className="container" style={{ paddingBlock: "clamp(1.5rem, 4vw, 2.5rem)" }}>
        <div style={{ display: "flex", gap: "clamp(1.5rem, 3vw, 2.5rem)", alignItems: "start" }}>
          ...
          {/* Desktop Sidebar */}
          <aside style={{ width: "var(--sidebar-width)", flexShrink: 0, display: "none" }} className="lg:block">
            <div style={{
              display: "flex", alignItems: "center", justifyContent: "space-between",
      ...
      <style>{`
        ...
        /* ── Page header centering — mobile-first ── */
        ...
        /* Title row: stacked, centered on mobile */
        .products-title-row {
          display: flex;
        ...
        /* lg+: left-aligned row layout */
        @media (min-width: 1024px) {
          .products-header-body { text-align: left; }
          .products-breadcrumb-ol { justify-content: flex-start !important; }
          .products-title-row {
            flex-direction: row;
            align-items: flex-end;
            justify-content: space-between;
          }
          .products-title-text { text-align: left; }
        }
...
function ActiveChip({ label, onRemove }: { label: string; onRemove: () => void }) {
  return (
    <span style={{
      ...
      borderRadius: "var(--radius-full)", flexShrink: 0, maxWidth: "12rem",
    }}>
      ...
      <button
        ...
        style={{
          ...
          borderRadius: "var(--radius-full)", color: "rgba(245,184,64,0.6)",
          cursor: "pointer", transition: "all var(--transition-fast)",
