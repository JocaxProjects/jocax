...
const PREFILL_MESSAGE = encodeURIComponent(
  "Hi Jocax Solutions Limited! I'd like to enquire about your commercial kitchen equipment."
);
    ...
    <>
      ...
      >
        ...
        <a
          ...
          aria-label="Chat with Jocax Solutions Limited on WhatsApp — opens in new tab"
