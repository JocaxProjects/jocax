...
const SOCIAL_LINKS = [
  {
    href: "https://www.facebook.com/share/1AZrCDCWjh/", label: "Facebook",
    icon: (
  ...
  {
    href: "https://www.instagram.com/musembibeatrice?utm_source=qr&igsh=bTdlamp3MDcwMGk1", label: "Instagram",
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
  ...
  {
    href: "https://www.tiktok.com/@jocaxsolutions?_r=1&_t=ZS-95VhZKVe4dY", label: "TikTok",
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
